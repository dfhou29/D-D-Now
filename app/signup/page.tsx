  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-col justify-start h-screen items-center w-2/3 bg-slate-100 ml-auto mr-auto pt-16 overflow-y-auto bg-opacity-80">
        ...
        >
          <div className="flex flex-col justify-center mb-3 gap-x-4 w-64 ml-auto mr-auto">
            <label
              htmlFor="name"
          ...
          <div className="flex flex-col justify-center mb-3 gap-x-4 w-64 ml-auto mr-auto mb-4">
            <label
              htmlFor="password"
              className="text-gray-600 text-md font-bold mb-2 self-start capitalize"
            >
          ...
          <div className="flex flex-col justify-center items-center mb-3 gap-x-4 w-64 ml-auto mr-auto">
            <button
              className={
                "bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 w-64"
              }
              type="submit"
            >
              SIGN UP
